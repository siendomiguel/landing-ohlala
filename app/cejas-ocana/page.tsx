...
export const metadata: Metadata = {
  title: 'Depilación de Cejas en Ocaña Centro - Diseño con Visagismo',
  description:
    'Depilación de cejas en Ocaña centro con visagismo. Depilación con cuchilla, hilo y cera. Diseño personalizado de cejas. Calle 10 #10-19. Agenda tu cita.',
  alternates: {
    canonical: '/cejas-ocana',
  },
  openGraph: {
...
const servicios = [
  'Depilación con visagismo',
  'Depilación con cuchilla',
  'Depilación con hilo',
  'Depilación con cera',
];

export default function CejasOcana() {
  return (
    <>
      <Script id="cejas-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      ...
      <div className="flex flex-col space-y-6 w-full pb-8">
        <div className="text-center bg-white/80 backdrop-blur-sm text-purple-800 py-4 px-8 rounded-2xl shadow-sm border border-white/50">
          <h2 className="text-xl font-bold">Cejas en Ocaña Centro</h2>
          <p className="text-purple-600 text-sm mt-1">Diseño y depilación profesional de cejas</p>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-md border border-white/50">
          <p className="text-gray-800 font-medium text-center leading-relaxed">
            En <strong className="text-purple-800">Ohlala Estudio de Belleza</strong> diseñamos
            tus cejas de forma personalizada con visagismo profesional. Contamos con diferentes
            técnicas de depilación para adaptarnos a tu preferencia.
          </p>
        </div>
        ...
        <Link href="https://wa.me/573212600682?text=Hola%2C%20quiero%20agendar%20una%20cita%20para%20cejas" target="_blank" className="block group">
