...
export const metadata: Metadata = {
  title: 'Maquillaje en Ocaña Centro - Maquillaje para Eventos',
  description:
    'Maquillaje profesional en Ocaña centro. Maquillaje para eventos sociales, fiestas, graduaciones y ocasiones especiales. Calle 10 #10-19. Agenda tu cita.',
  alternates: {
    canonical: '/maquillaje-ocana',
  },
  openGraph: {
...
const servicios = [
  'Maquillaje para eventos sociales',
];

export default function MaquillajeOcana() {
  return (
    <>
      <Script id="maquillaje-jsonld" type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(jsonLd) }} />
      ...
      <div className="flex flex-col space-y-6 w-full pb-8">
        <div className="text-center bg-white/80 backdrop-blur-sm text-purple-800 py-4 px-8 rounded-2xl shadow-sm border border-white/50">
          <h2 className="text-xl font-bold">Maquillaje en Ocaña Centro</h2>
          <p className="text-purple-600 text-sm mt-1">Maquillaje profesional para eventos</p>
        </div>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 shadow-md border border-white/50">
          <p className="text-gray-800 font-medium text-center leading-relaxed">
            En <strong className="text-purple-800">Ohlala Estudio de Belleza</strong> te ofrecemos
            maquillaje profesional para que luzcas espectacular en tus eventos sociales, fiestas,
            graduaciones y cualquier ocasión especial.
          </p>
        </div>
        ...
        <Link href="https://wa.me/573212600682?text=Hola%2C%20quiero%20agendar%20una%20cita%20de%20maquillaje" target="_blank" className="block group">
